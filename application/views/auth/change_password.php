        ...
        <div class="card-body">
            ...
            <div class="form-group ">
                <div class="col-xs-12">
                    ...
                    <p class="text-muted"><?php echo lang('change_password_subheading'); ?> </p>
                </div>
            </div>            
            ...
            <div class="form-group ">
                <div class="col-xs-12">
                    <input class="form-control" id="old" name="old" type="password" required placeholder="Vecchia password" pattern="^.{8}.*$"> 
                </div>
            </div>
            <div class="form-group">
                <div class="col-xs-12">
            ...
            <div class="form-group text-center m-t-20">
                <div class="col-xs-12">
                    <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit"><?php echo lang('change_password_submit_btn'); ?></button>
                </div>
            </div>     
            <div class="form-group text-center m-t-20">
                <div class="col-sm-12 text-center">
                    <div><a href="<?php echo base_url(); ?>" class="text-info"><b>Torna al portale</b></a></div>
                </div>
            </div>             

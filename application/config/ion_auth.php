...
*/
$config['tables']['users']           = 'sys_users';
$config['tables']['groups']          = 'sys_groups';
$config['tables']['users_groups']    = 'sys_users_groups';
$config['tables']['login_attempts']  = 'sys_login_attempts';
 ...
 */
$config['site_title']                 = "Candidature SEP";            // Site Title, example.com
$config['admin_email']                = "candidature_sep@regione.campania.it"; // Admin Email, admin@example.com
$config['default_group']              = 'utente';           // Default group, use name
